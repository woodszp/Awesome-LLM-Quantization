...
This repository is built upon and inspired by the following excellent resources:

1. **[Kai-Liu001/Awesome-Model-Quantization](https://github.com/Kai-Liu001/Awesome-Model-Quantization)** - Comprehensive collection of low-bit quantization papers from 2020-2026

2. **[Efficient-ML/Awesome-Model-Quantization](https://github.com/Efficient-ML/Awesome-Model-Quantization)** - Extensive quantization paper collection with benchmarks (BiBench, MQBench)

We deeply appreciate the authors and contributors of these repositories for their valuable work in curating and maintaining these resources.

---

## 📚 Today's Papers (2026-03-18)

Today's paper update:
- **Total**: 106 papers
- **LLM Quantization**: 95 papers  
- **Edge Deployment**: 5 papers
- **UAV Vision**: 6 papers

*Daily papers automatically fetched from arXiv.*
...
- [Awesome Model Compression](https://github.com/00shao/awesome-model-compression)
